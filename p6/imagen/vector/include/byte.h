...
Muestra por la salida est�ndar una secuencia de 0s y 1s correspondiente  al estado de cada bit del byte donde un cero representa que un bit est� apagado y un uno que el bit est� encendido. Se implementa utilizando la funci�n "getbit".
...
// @brief devuelve un string con una secuencia de 0’s y 1’s // correspondiente al estado de cada bit. Se debe
// implementar utilizando la funcio ́n ”getbit”
